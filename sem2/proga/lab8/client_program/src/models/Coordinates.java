...
public class Coordinates implements Serializable {
    ...
    public static final long MAX_X_INCL = 846l;
    public static final float MIN_Y_EXCL = -849f;
    ...
    public void setX(Long _x) {
        if (_x == null || _x > MAX_X_INCL) throw new WrongCoordinatesException();
        x = _x;
    }
    ...
    public void setY(Float _y) {
        if (_y == null || _y <= MIN_Y_EXCL) throw new WrongCoordinatesException();
        y = _y;
    }
